...
const Notification = () => {
    ...
    const {notifications, userChat, allUsers, markAllNotificationsAsRead, markNotificationsAsRead} = useContext(ChatContext);
...
{unreadNotifications?.length === 0 ? null : (
    ...
    <div className="mark-as-read" onClick={() => markAllNotificationsAsRead(notifications)}>Mark all as read</div>
        ...
        {modifiedNotifications && modifiedNotifications.map((n, index) => {
            ...
            onClick={() =>{
                markNotificationsAsRead(n, userChat, user, notifications)
            }}>
